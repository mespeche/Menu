...
class MenuTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Visible', 'Position', 'Name', 'Identifier', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'visible', 'position', 'name', 'identifier', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(MenuTableMap::ID, MenuTableMap::VISIBLE, MenuTableMap::POSITION, MenuTableMap::NAME, MenuTableMap::IDENTIFIER, MenuTableMap::CREATED_AT, MenuTableMap::UPDATED_AT, ),
        self::TYPE_RAW_COLNAME   => array('ID', 'VISIBLE', 'POSITION', 'NAME', 'IDENTIFIER', 'CREATED_AT', 'UPDATED_AT', ),
        self::TYPE_FIELDNAME     => array('id', 'visible', 'position', 'name', 'identifier', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Visible' => 1, 'Position' => 2, 'Name' => 3, 'Identifier' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'visible' => 1, 'position' => 2, 'name' => 3, 'identifier' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(MenuTableMap::ID => 0, MenuTableMap::VISIBLE => 1, MenuTableMap::POSITION => 2, MenuTableMap::NAME => 3, MenuTableMap::IDENTIFIER => 4, MenuTableMap::CREATED_AT => 5, MenuTableMap::UPDATED_AT => 6, ),
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'VISIBLE' => 1, 'POSITION' => 2, 'NAME' => 3, 'IDENTIFIER' => 4, 'CREATED_AT' => 5, 'UPDATED_AT' => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'visible' => 1, 'position' => 2, 'name' => 3, 'identifier' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MenuTableMap::NAME);
